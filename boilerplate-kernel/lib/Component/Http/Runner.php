...
{
    /** @var \SplQueue<\Component\Http\MiddlewareInterface> */
    private SplQueue $pipeline;

    /**
     * @param  \Psr\Container\ContainerInterface               $container
     * @param  \Component\Http\MiddlewareInterface[]|string[]  $pipeline
     */
    ...
    public function handle(Request $request): Response
    {
        ...
        /** @var \Component\Http\MiddlewareInterface|string $middleware */
